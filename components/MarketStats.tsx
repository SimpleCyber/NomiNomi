...
const newMarkets = [
  { symbol: "MON-PERP", price: "$0.037338", change: "-15.39%", isPositive: false },
  { symbol: "ZRO-PERP", price: "$1.35", change: "+2.82%", isPositive: true },
  { symbol: "PAXG-PERP", price: "$4,184.47", change: "+0.82%", isPositive: true },
  { symbol: "MET-PERP", price: "$0.3387", change: "-4.16%", isPositive: false },
  { symbol: "PIPE-PERP", price: "$0.06508", change: "+0.82%", isPositive: true },
];

const topMovers = [
  { symbol: "MON-PERP", price: "$0.037338", change: "-15.39%", isPositive: false },
  { symbol: "BERA-PERP", price: "$0.9476", change: "-8.55%", isPositive: false },
...
const popular = [
  { symbol: "BTC-PERP", price: "$91,443.20", change: "+0.00%", isPositive: true },
  { symbol: "ETH-PERP", price: "$3,022.44", change: "-0.47%", isPositive: false },
  { symbol: "BNB-PERP", price: "$896.84", change: "+0.21%", isPositive: true },
  { symbol: "SOL-PERP", price: "$140.23", change: "-1.96%", isPositive: false },
  { symbol: "MON-PERP", price: "$0.037338", change: "-15.39%", isPositive: false },
];

const StatCard = ({ title, data }: { title: string; data: typeof newMarkets }) => (
      ...
      {data.map((item, index) => (
        <div key={index} className="flex justify-between items-center group cursor-pointer">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-[var(--foreground)] group-hover:text-blue-500 transition-colors">{item.symbol}</span>
          </div>
          <div className="flex items-center gap-4">
            <span className="text-sm text-[var(--foreground)] font-medium">{item.price}</span>
