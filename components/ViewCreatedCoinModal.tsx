...
export default function ViewCreatedCoinModal({
  isOpen,
  onClose,
  coin,
}: ViewCreatedCoinModalProps) {
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between p-6 border-b border-gray-800 bg-[#141519]/95 backdrop-blur shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div
                className={`text-sm font-medium ${coin.change?.startsWith("+") ? "text-green-400" : "text-red-400"}`}
              >
                {coin.change} Today
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#1a1b1f] p-5 rounded-xl border border-gray-800">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  When the bonding curve reaches 100%, the liquidity will be
                  deposited into a DEX.
                </p>
              </div>
