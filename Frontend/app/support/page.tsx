          ...
          <div className="w-full max-w-[1200px] mx-auto space-y-8">
            ...
            <div className="text-center space-y-4 py-8">
              ...
              <p className="text-[var(--muted)] text-lg max-w-2xl mx-auto">
                ...
                assistance with your account, trading, or technical issues.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[var(--card-bg)] p-6 rounded-2xl border border-[var(--border-color)] hover:border-green-500/50 transition-colors group cursor-pointer">
                ...
                <p className="text-[var(--muted)] mb-4">
                  Browse our detailed guides and tutorials to learn more.
                </p>
                ...
                {[
                  {
                    ...
                    a: "Click the 'Sign Up' button in the top right corner and follow the instructions to verify your email and identity.",
                  },
                  {
                    q: "What are the trading fees?",
                    a: "Our standard trading fee is 0.1% for both makers and takers. VIP users enjoy lower rates based on volume.",
                  },
                  {
                    q: "Is my fund secure?",
                    a: "Yes, we use industry-leading security measures including cold storage and multi-signature wallets to protect your assets.",
                  },
                  {
                    q: "How can I deposit funds?",
                    a: "Go to your Wallet page, select 'Deposit', and choose your preferred cryptocurrency or fiat payment method.",
                  },
                ].map((faq, idx) => (
                  <div
                    key={idx}
                    className="border-b border-[var(--border-color)] last:border-none pb-4 last:pb-0"
                  >
              ...
              <form className="space-y-4 max-w-2xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      className="w-full bg-[var(--input-bg)] border border-[var(--border-color)] rounded-lg px-4 py-2 text-[var(--foreground)] focus:outline-none focus:border-blue-500 transition-colors"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    className="w-full bg-[var(--input-bg)] border border-[var(--border-color)] rounded-lg px-4 py-2 text-[var(--foreground)] h-32 resize-none focus:outline-none focus:border-blue-500 transition-colors"
