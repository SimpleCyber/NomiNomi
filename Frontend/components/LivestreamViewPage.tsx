                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-[var(--muted)] leading-relaxed">
                        {stream.description ||
                          "No description available for this stream."}
                      </p>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[var(--card-bg)] rounded-xl border border-[var(--border-color)] overflow-hidden">
              <div className="p-4 border-b border-[var(--border-color)] flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  ...
                  <span className="text-xs bg-[var(--input-bg)] text-[var(--muted)] px-2 py-0.5 rounded">
                    Short
                  </span>
                </div>
              </div>
            ...
            <div className="bg-[var(--card-bg)] rounded-xl border border-[var(--border-color)] p-5">
              ...
              <p className="text-xs text-[var(--muted)] mt-3">
                This coin has graduated from the bonding curve and is now
